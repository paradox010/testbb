...
interface TreeState<TreeDataType extends BasicDataNode = DataNode> {
  ...
  draggingNodeKey: React.Key | null | undefined;
...
> {
  ...
  dragStartMousePosition: { x: number; y: number } | null = null;
  ...
  setExpandedKeys = (expandedKeys: Key[]) => {
    ...
    const flattenNodes: FlattenNode<TreeDataType>[] = flattenTreeData<TreeDataType>(treeData, expandedKeys, fieldNames);
    this.setUncontrolledState(
      {
        expandedKeys,
        flattenNodes,
